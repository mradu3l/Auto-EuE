...
url = "http://www.zone-h.org/archive/published=0/notifier="
urll = "http://www.zone-h.org/archive/published=0"
...
def zonehh():
	print("""
		...
		\033[91m[1] \033[95mGrabb Sites By Notifier Onhold
...
def binger():
	...
	if o == 1:
		...
		for done in gr:
		    ...
		    page = 1
		    while page < 251:
		        bing = "http://www.bing.com/search?q=ip%3A%20%22"+done+"+&count=50&first="+str(page)
		...
		for done in gr:
		    ...
		    while page < 251:
		        bing = "http://www.bing.com/search?q=ip%3A%20%22"+done+ " powered by fox_contact"+"+&count=50&first="+str(page)
		        opene = requests.get(bing,verify=False,headers=qwd)
		        read = opene.content
		        findwebs = re.findall('<h2><a href="(.*?)"', read)
		        for i in findwebs:
		        ...
		        bing = "http://www.bing.com/search?q=ip%3A%20%22"+done+ " admin/login.php"+"+&count=50&first="+str(page)
		        opene = requests.get(bing,verify=False,headers=qwd)
		        read = opene.content
		        findwebs = re.findall('<h2><a href="(.*?)"', read)
		        for i in findwebs:
...
MMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMM
MMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMM
MMMMMMMMMMMMMMMMMMMMMMMMMMMMM?8MMMMMMMMMMMMMMMM?NMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMM
MMMMMMMMMMMMMMMMMMMMMMMMMMMMM+::MMMMMMMMMMMMMMM::IMMMMMMMMMMMMMMMMMMMMMMMMMMMMMM
MMMMMMMMMMMMMMMMMMMMMMMMMMMMM+:::MMMMMMMMMMMMMM:,IMMMMMMMMMMMMMMMMMMMMMMMMMMMMMM
MMMMMMMMMMMMMMMMMMMMMMMMMMMMM+:I::MMMMMMMMMMMMM:,IMMMMMMMMMMMMMMMMMMMMMMMMMMMMMM
MMMMMMMMMMMMMMMMMMMMMMMMMMMMM+:IM,:ZMMMMMMMMMMM:,IMMMMMMMMMMMMMMMMMMMMMMMMMMMMMM
MMMMMMMMMMMMMMMMMMMMMMMMMMMMM+:IMM+,:MMMMMMMMMM:,IMMMMMMMMMMMMMMMMMMMMMMMMMMMMMM
MMMMMMMMMMMMMMMMMMMMMMMMMMMMM+:IMMMN::MMMMMMMMM:,IMMMMMMMMMMMMMMMMMMMMMMMMMMMMMM
MMMMMMMMMMMMMMMMMMMMMMMMMMMMM+:IMMMMM::MMMMMMMM:,IMMMMMMMMMMMMMMMMMMMMMMMMMMMMMM
MMMMMMMMMMMMMMMMMMMMMMMMMMMMM+:IMMMMMM,:8MMMMMM:,IMMMMMMMMMMMMMMMMMMMMMMMMMMMMMM
MMMMMMMMMMMMMMMMMMMMMMMMMMMMM+:IMMMMMMM+:=MMMMM:,IMMMMMMMMMMMMMMMMMMMMMMMMMMMMMM
MMMMMMMMMMMMMMMMMMMMMMMMMMMMM+:IMMMMMMMMO::MMMM:,IMMMMMMMMMMMMMMMMMMMMMMMMMMMMMM
MMMMMMMMMMMMMMMMMMMMMMMMMMMMM+:IMMMMMMMMMM,:NMM:,IMMMMMMMMMMMMMMMMMMMMMMMMMMMMMM
MMMMMMMMMMMMMMMMMMMMMMMMMMMMM+:IMMMMMMMMMMM,:MM:,IMMMMMMMMMMMMMMMMMMMMMMMMMMMMMM
MMMMMMMMMMMMMMMMMMMMMMMMMMMMM+:IMMMMMMMMMMMM,:$::IMMMMMMMMMMMMMMMMMMMMMMMMMMMMMM
MMMMMMMMMMMMMMMMMMMMMMMMMMMMM+:IMMMMMMMMMMMMM+:::IMMMMMMMMMMMMMMMMMMMMMMMMMMMMMM
MMMMMMMMMMMMMMMMMMMMMMMMMMMMM=:IMMMMMMMMMMMMMMD::IMMMMMMMMMMMMMMMMMMMMMMMMMMMMMM

                                \033[91m[N]e[V]e[R]\033[92m[D]i[E] 
	"""
...
MMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMM
                                \033[91m[N]e[V]e[R]\033[92m[D]i[E] 
                                     """)
	slowprint("\n\t\t\t\t\t Powered : Trojan Kil3r Amazigh " + "\n\t\t\t\t\t\t        ")
	print("")
	print("""
		|   \033[91m[0] \033[93mCMS Lookup
		...
		\033[91m[9] \033[95mEmail Valid Spotify
			...
			""")		
	try:
		qq = int(raw_input("\033[91m[-] \033[90mroot@NyenderID~# \033[92mChoose Section !!\033[95m : \033[90m"))
		if qq == 0:
			clearscrn()
			print(banner)
			botv1()
